...
muonPhysics::muonPhysics() : G4VUserPhysicsList()
{
...
void muonPhysics::ConstructMyBosons()
{
  // pseudo-particles
...
void muonPhysics::ConstructMyLeptons()
{
  // leptons
...
void muonPhysics::ConstructMyShortLiveds()
{
...
void muonPhysics::AddTransportation() {
...
void muonPhysics::ConstructGeneral() {
